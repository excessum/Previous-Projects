...
/**
 * Default RNG Class supplied from the original example. Additional
 * constructors are still not used although they can be added in the
 * RNGFactory for additional customisation. 
 * @author Andrew Jones
 *
 */
